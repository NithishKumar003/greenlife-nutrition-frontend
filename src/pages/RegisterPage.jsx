...
export default function RegisterPage({ onNavigate }) {
  ...
  return (
    <section className="p-6 md:p-10 bg-blue-100 m-6 md:m-14 mt-12 rounded-xl flex justify-center items-center min-h-[75vh]">
      <div className="flex flex-col gap-6 justify-center items-center w-full max-w-md">
        ...
        {successMessage && (
          <div className="w-full bg-green-200 text-green-800 p-3 rounded-md text-sm text-center">
            {successMessage}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          ...
          <div className="flex items-center justify-start px-4 py-2 bg-white rounded-full shadow-sm">
            <svg className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="6" r="4" stroke="#1C274C" strokeWidth="1.5" />
              <path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" stroke="#1C274C" strokeWidth="1.5" />
            </svg>
            <input
              type="text"
              name="username"
          ...
          {/* Email Field */}
          <div className="flex items-center justify-start px-4 py-2 bg-white rounded-full shadow-sm">
            <svg className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0" viewBox="0 0 512 512" fill="currentColor">
